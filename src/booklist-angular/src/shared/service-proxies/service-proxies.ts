...
export class BookServiceProxy {
     ...
     * @return Success
     */
    getPagedBookAsync(filterText: string | null | undefined, sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfBookListDto> {
        let url_ = this.baseUrl + "/api/services/app/Book/GetPagedBookAsync?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetPagedBookAsync(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetPagedBookAsync(<any>response_);
                } catch (e) {
    ...
    protected processGetPagedBookAsync(response: HttpResponseBase): Observable<PagedResultDtoOfBookListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    createOrUpdateBookAsync(input: CreateOrUpdateBookInput | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Book/CreateOrUpdateBookAsync";
        url_ = url_.replace(/[?&]$/, "");
    ...
    deleteBookAsync(id: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Book/DeleteBookAsync?";
        if (id !== undefined)
    ...
    batchDeleteAsync(input: number[] | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Book/BatchDeleteAsync";
        url_ = url_.replace(/[?&]$/, "");
...
export class RoleServiceProxy {
     ...
     * @return Success
     */
    getRoleForEditAsync(id: number | null | undefined): Observable<GetRoleForEditOutput> {
        let url_ = this.baseUrl + "/api/services/app/Role/GetRoleForEditAsync?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetRoleForEditAsync(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetRoleForEditAsync(<any>response_);
                } catch (e) {
    ...
    protected processGetRoleForEditAsync(response: HttpResponseBase): Observable<GetRoleForEditOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
